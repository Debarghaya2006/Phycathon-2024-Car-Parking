...
void loop(){ 
  ...
  if (digitalRead(IR2) == LOW && flag2 == 0) {
    ...
    delay(3000);       // Give the car enough time to exit (5 seconds)
    Slot++;            // Increase the slot count
  }

  // Close the gate after the car has passed
  if (flag1 == 1 || flag2 == 1) {
    delay(1000);           // Additional delay to ensure the car has fully passed (3 seconds)
    ...
    flag1 = 0;
    flag2 = 0;
    delay(1000);  // Small delay to prevent immediate re-triggering
  }
